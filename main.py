    ...
    def steps(self,entry):
        ...
        try:
            ...
            # String Method for LAST
                ...
                EXPRESSION_FOLIED = "Expression FOILed:  " + '[color=33CAFF]' + FOIL + '[/color]'
            ...
            #First evaled, check for if Exponent, Variable, Integer
                ...
                while i < 1: #Highlight each possible combo
                    ...
                    if exponent_First_evaled != " " and exponent_evaled_Outside  != " " and exponent_Inside_evaled != " " and exponent_Last_evaled != " ":
                        ...
                        COMBINED_TERMS_EVALED = "Terms Combined: " + Back.BLUE + str(eval(exponent_First_evaled + exponent_evaled_Outside + exponent_Inside_evaled + exponent_Last_evaled)).replace("*","").replace("**","^") + '[/color]'
                ...
                FINAL_ANSWER = str(combined_exponents) + "+" + str(combined_variables) + "+" + str(combined_integers)
